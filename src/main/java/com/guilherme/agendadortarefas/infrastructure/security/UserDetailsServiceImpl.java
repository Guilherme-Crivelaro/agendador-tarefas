...
public class UserDetailsServiceImpl {
    ...
    public UserDetails carregaDadosUsuario(String email, String token){
        ...
        UsuarioDTO usuarioDTOdto = client.buscaUsuarioPorEmail(email, token);
        return User
                .withUsername(usuarioDTOdto.getEmail()) // Define o nome de usuário como o e-mail
                .password(usuarioDTOdto.getSenha()) // Define a senha do usuário
                .build();
